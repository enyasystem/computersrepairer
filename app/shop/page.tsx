...
const products = [
	{
		...
		description:
			"High-performance gaming laptop with RTX 4060, 16GB RAM, and 1TB SSD",
		price: "₦1,299.99",
	...
	},
	{
		...
		description:
			"Full HD 1080p webcam with auto-focus and built-in microphones",
		price: "₦69.99",
		originalPrice: "₦89.99",
		rating: 4.6,
	...
	},
	{
		...
		description:
			"Professional 4K monitor with excellent color accuracy and USB-C hub",
		price: "₦449.99",
		originalPrice: null,
		rating: 4.9,
	...
	},
	{
		...
		description:
			"High-speed 32GB DDR4 memory kit for enhanced performance",
		price: "₦129.99",
		originalPrice: null,
		rating: 4.7,
	...
	},
	{
		...
		description:
			"8-core, 16-thread processor for high-performance computing",
		price: "₦279.99",
				...
				<div className="container mx-auto px-4">
					<div className="text-center">
						...
						<p className="text-xl text-muted-foreground max-w-2xl mx-auto text-pretty">
							High-quality computer components and accessories for all your
							tech needs
						</p>
					</div>
				</div>
