    ...
    <footer className="bg-secondary text-secondary-foreground">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/services/it-support" className="hover:text-primary transition-colors">
                  IT Support
                </Link>
              </li>
              <li>
                <Link href="/services/networking" className="hover:text-primary transition-colors">
                  Networking
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-secondary-foreground/20 mt-8 pt-8 text-center text-sm text-secondary-foreground/80">
          <p>&copy; 2024 ComputersRepairer. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
